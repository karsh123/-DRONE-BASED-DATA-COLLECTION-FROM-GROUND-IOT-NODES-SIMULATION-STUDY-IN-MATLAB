...
#define isDWorkPresent                                                         \
    (((!ssRTWGenIsCodeGen(S) || isSimulationTarget) && !ssIsExternalSim(S)) || \
...
static void mdlStart(SimStruct* S) {
    ...
    busInfo[4] = dtaGetDataTypeElementOffset(dta, bpath, EnvironmentBusId, 1) +
                 dtaGetDataTypeElementOffset(dta, bpath, AtmosphereBusId, 0);
    busInfo[5] = dtaGetDataTypeSize(dta, bpath, ssGetDataTypeId(S, "double"));
    busInfo[6] = dtaGetDataTypeElementOffset(dta, bpath, EnvironmentBusId, 1) +
                 dtaGetDataTypeElementOffset(dta, bpath, AtmosphereBusId, 1);
    busInfo[7] = dtaGetDataTypeSize(dta, bpath, ssGetDataTypeId(S, "double"));
    busInfo[8] = dtaGetDataTypeElementOffset(dta, bpath, EnvironmentBusId, 1) +
                 dtaGetDataTypeElementOffset(dta, bpath, AtmosphereBusId, 2);
    busInfo[9]  = dtaGetDataTypeSize(dta, bpath, ssGetDataTypeId(S, "double"));
    busInfo[10] = dtaGetDataTypeElementOffset(dta, bpath, EnvironmentBusId, 1) +
                  dtaGetDataTypeElementOffset(dta, bpath, AtmosphereBusId, 3);
...
static void mdlOutputs(SimStruct* S, int_T tid) {
    ...
    linearInputBus_Outputs_wrapper(Actuators, &_u1BUS, ActuatorsTrim, AirDensityTrim, AirTempTrim,
                                   PressureTrim, SpeedOfSoundTrim, GravityNEDTrim,
                                   MagneticFieldNEDTrim, y);
